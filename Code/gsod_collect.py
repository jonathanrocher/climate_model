...
# ETS imports
from traits.api import HasTraits, Enum, Array, Dict
...
def read_ish_history():
    ...
    dtypes = np.dtype([(name, dtype) for name, dtype in zip(col_names, types)])
...
if __name__ == "__main__":
    ...
    paris_data_temp_downsampled = downsample(paris_data_temp,
        method="average", offset="unique_month")
